...
export const MESSAGE_SECTIONS: MessageSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "hero.miniStats.years", label: "Стат: годы" },
      { path: "hero.miniStats.projects", label: "Стат: проекты" },
      { path: "hero.miniStats.countries", label: "Стат: страны" },
      { path: "hero.miniStats.services", label: "Стат: услуги" },
    ],
  },
  {
    id: "home",
